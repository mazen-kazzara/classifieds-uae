...
const faqsEn: FAQ[] = [
  ...
  { q: "Is it free to post an ad?", a: "Yes. We offer a free plan that lets you post an ad with up to 150 characters and 1 image for 3 days at no cost. For more reach, paid plans start from 5 AED." },
  { q: "What plans are available?", a: "We offer 4 plans: Free (0 AED, 150 chars, 1 image, 3 days); Basic (5 AED, 400 chars, 2 images, 7 days); Standard (9 AED, 800 chars, 4 images, 14 days — Best Value); and Premium (15 AED, 1200 chars, 6 images, 30 days). Visit our Pricing page for full details." },
  { q: "How do I post an ad?", a: "Three ways: (1) through our website at classifiedsuae.ae, (2) via our WhatsApp bot, or (3) via our Telegram bot (@classifiedsuae_bot). All take less than a minute." },
  { q: "What categories are available?", a: "We support 17 categories: Cars, Real Estate, Jobs, Services, Mobiles, Electronics, Computers & Games, Furniture, Fashion & Clothing, Education & Training, Salons & Beauty, Clinics, Pets, Equipment & Tools, Others, Jewelry & Accessories, and Watches." },
  ...
  { q: "How do buyers contact me?", a: "When posting, you choose your preferred contact methods: Call and/or WhatsApp. Buyers will see the contact options you selected on your ad page." },
  ...
  { q: "Can I post from WhatsApp or Telegram?", a: "Yes. Both our WhatsApp bot and Telegram bot (@classifiedsuae_bot) offer the full ad creation experience — choose a plan, add details, upload images, select platforms, and publish. They even recognize returning users by phone number." },
...
const faqsAr: FAQ[] = [
  ...
  { q: "هل نشر الإعلان مجاني؟", a: "نعم. نوفر خطة مجانية تتيح لك نشر إعلان بحد أقصى 150 حرف وصورة واحدة لمدة 3 أيام بدون أي تكلفة. للحصول على مزيد من الوصول، الخطط المدفوعة تبدأ من 5 درهم." },
  { q: "ما هي الخطط المتاحة؟", a: "نوفر 4 خطط: مجاني (0 د.إ، 150 حرف، صورة واحدة، 3 أيام)؛ أساسي (5 د.إ، 400 حرف، صورتين، 7 أيام)؛ قياسي (9 د.إ، 800 حرف، 4 صور، 14 يوماً — الأفضل قيمة)؛ وبريميوم (15 د.إ، 1200 حرف، 6 صور، 30 يوماً). زر صفحة الأسعار للتفاصيل الكاملة." },
  { q: "كيف أنشر إعلاناً؟", a: "بثلاث طرق: (1) عبر موقعنا classifiedsuae.ae، (2) عبر بوت واتساب، أو (3) عبر بوت تيليغرام (@classifiedsuae_bot). الجميع يستغرق أقل من دقيقة." },
  { q: "ما هي الفئات المتاحة؟", a: "ندعم 17 فئة: سيارات، عقارات، وظائف، خدمات، موبايلات، إلكترونيات، كمبيوتر وألعاب، أثاث، ملابس وأزياء، تعليم وتدريب، صالونات وتجميل، عيادات، حيوانات أليفة، معدات وأدوات، أخرى، مجوهرات وإكسسوارات، وساعات." },
  ...
  { q: "كيف يتواصل المشترون معي؟", a: "عند النشر، تختار طرق التواصل المفضلة: اتصال و/أو واتساب. سيرى المشترون خيارات التواصل التي اخترتها في صفحة إعلانك." },
  ...
  { q: "هل يمكنني النشر من واتساب أو تيليغرام؟", a: "نعم. بوت واتساب وبوت تيليغرام (@classifiedsuae_bot) يوفران تجربة إنشاء إعلانات كاملة — اختر خطة، أضف تفاصيل، ارفع صور، حدد المنصات، وانشر. البوتات تتعرف أيضاً على المستخدمين العائدين برقم الهاتف." },
...
export default async function FAQPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const rawFaqs = isAr ? faqsAr : faqsEn;
  // After May 1: remove UAE Flag FAQ and update plan references
  const faqs = showUAE ? rawFaqs : rawFaqs
    .filter(f => !f.q.includes("UAE Flag") && !f.q.includes("علم الإمارات"))
    .map(f => ({
      ...f,
      a: f.a
        .replace(/ We also have a special launch offer — the UAE Flag plan — which is FREE until May 1st with 800 characters and 4 images\./g, "")
        .replace(/ ولدينا أيضاً عرض خاص — خطة 🇦🇪 علم الإمارات — مجانية حتى 1 مايو مع 800 حرف و4 صور\./g, "")
        .replace(/We offer 5 plans:/g, "We offer 4 plans:")
        .replace(/نوفر 5 خطط:/g, "نوفر 4 خطط:")
        .replace(/ 🇦🇪 UAE Flag — FREE until May 1st \(Launch Offer, 800 chars, 4 images, 14 days\);/g, "")
        .replace(/ 🇦🇪 علم الإمارات — مجاني حتى 1 مايو \(عرض الإطلاق، 800 حرف، 4 صور، 14 يوماً\)؛/g, ""),
    }));
