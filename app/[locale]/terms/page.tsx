          ...
          <div style={{ color: "var(--text-muted)", lineHeight: 1.9, fontSize: "0.9375rem" }}>
            ...
            <div style={{ overflowX: "auto", marginBottom: "1rem" }}>
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.875rem" }}>
                ...
                <tbody>
                  {isAr ? <>
                    <tr><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>مجاني</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>0 د.إ</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>3 أيام</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>نص فقط، بدون صور</td></tr>
                    <tr style={{ backgroundColor: "var(--surface-2)" }}><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>عادي</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>10–15 د.إ</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>7 أيام</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>نص + حتى صورتين</td></tr>
                    <tr><td style={{ padding: "0.75rem", border: "1px solid var(--border)", fontWeight: 700, color: "var(--text)" }}>مميز</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)", fontWeight: 700, color: "var(--primary)" }}>25 د.إ</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>7 أيام</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>تثبيت في الأعلى + شارة مميزة + صورتان</td></tr>
                  </> : <>
                    <tr><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>Free</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>0 AED</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>3 days</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>Text only, no images</td></tr>
                    <tr style={{ backgroundColor: "var(--surface-2)" }}><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>Standard</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>10–15 AED</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>7 days</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>Text + up to 2 images</td></tr>
                    <tr><td style={{ padding: "0.75rem", border: "1px solid var(--border)", fontWeight: 700, color: "var(--text)" }}>Featured</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)", fontWeight: 700, color: "var(--primary)" }}>25 AED</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>7 days</td><td style={{ padding: "0.75rem", border: "1px solid var(--border)" }}>Pinned top + featured badge + 2 images</td></tr>
                  </>}
                </tbody>
              </table>
            </div>
            <p style={pStyle}>{isAr
              ? "تُزال الإعلانات تلقائياً من الموقع بعد انتهاء صلاحيتها. أما المنشورات على قنوات التواصل الاجتماعي فقد تبقى مرئية على تلك المنصات. يتوفر تجديد الإعلان قبل انتهاء الصلاحية أو بعدها بنفس سعر الخطة."
              : "Ads are automatically removed from the website after expiry. Posts published to social channels may remain visible on those platforms. Ad renewal is available before or after expiry at the applicable plan rate."
            }</p>
            ...
            <p style={pStyle}>{isAr
              ? "تخضع شروط الخدمة هذه حصرياً لقوانين الإمارات العربية المتحدة. يخضع أي نزاع ناشئ عن استخدام هذه المنصة للاختصاص القضائي الحصري لمحاكم إمارة عجمان، الإمارات العربية المتحدة."
              : "These Terms of Service are governed exclusively by the laws of the United Arab Emirates. Any dispute arising from the use of this Platform shall be subject to the exclusive jurisdiction of the courts of the Emirate of Ajman, UAE."
            }</p>
